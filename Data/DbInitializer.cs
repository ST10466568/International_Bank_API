...
public static class DbInitializer
{
    public static async Task SeedUsers(UserManager<ApplicationUser> userManager, RoleManager<ApplicationRole> roleManager)
    {
        ...
        {
            var adminUser = new ApplicationUser { UserName = "admin", Email = "admin@hopewell.com", EmailConfirmed = true };
        ...
        {
            var doctorUser = new ApplicationUser { UserName = "doctor", Email = "doctor@hopewell.com", EmailConfirmed = true };
        ...
        {
            var patientUser = new ApplicationUser { UserName = "patient", Email = "patient@hopewell.com", EmailConfirmed = true };
